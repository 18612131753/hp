...
<!-- BEGIN CONTENT BODY=================================================================== -->
				<div class="page-content" >
					...
					<div class="portlet-body form">
						<!-- BEGIN FORM-->
						<form id="modfileform" method="post" enctype="multipart/form-data" action="${contextPath}/hp/modelTrainingAddFile" class="form-horizontal form-bordered">
							<div class="form-body">
								<div class="form-group">
									<label class="control-label col-md-3">选择训练文件</label>
									<div class="col-md-3">
