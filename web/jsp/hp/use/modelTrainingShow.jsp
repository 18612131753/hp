                    ...
                    <tbody>
                        <c:forEach var="hmt" items="${list}" >
                            <tr class="odd gradeX">
                                ...
                                <td style="text-align:center;vertical-align:middle;"> <span class="label label-sm label-success"> ${hmt.newgroup}</span> </td>
                                <td style="text-align:center;vertical-align:middle;">  ${hmt.newgroup == hmt.group ? '<span class="label label-sm label-success">YES</span>':'<span class="label label-sm label-error">NO</span>'} </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
